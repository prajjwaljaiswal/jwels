      ...
      <div className="p-6 space-y-6">
        <Field label="Shop section" hint="Group listings inside your storefront">
          <div className="flex gap-2 max-w-md">
            ...
            <Link href="/sections" target="_blank"
          ...
          {sections.length === 0 && (
            <span className="block text-[11px] text-ink-500 mt-1">
              No sections yet — <Link href="/sections" target="_blank" className="font-semibold text-brand-700 hover:underline">create one</Link> to group your listings.
            </span>
          )}
        </Field>
